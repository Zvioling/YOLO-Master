...
9. ✅ **SharedExpertESMoE vs 官方 MoE+MoT Shared（v08_moe_mot_shared）的诚实对比**：本项目 SharedExpertESMoE 用 DWconv 轻量专家做 P4/P5 共享（**实测参数−3.1%，2.814M→2.727M**，Expert 对象 16→12）；官方方案 D 用 Transformer 重型专家做 P3/P4 共享（**实测参数−19.1%，3.71M→3.00M**）。**轻量专家共享空间小是架构天然属性，非实现缺陷**——Transformer 专家有 FFN 重型参数可削减，而 DWconv 专家本身就是轻量结构。这是 ES-MoE 与 MoT 专家实现的本质差异，不是负面结论
...
**作者**：[张伟林 (Zviolin)](https://github.com/164321595) · 福州大学 计算机与大数据学院 软件工程 24 级
**日期**：2026 年 8 月 15 日
