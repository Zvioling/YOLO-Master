...
| 仓库类型 | 用途 | 位置 | 说明 |
|---------|------|------|------|
| **代码贡献仓库** | 向 YOLO-Master 提交 PR | `github.com/Zviolin/YOLO-Master` | Fork 自原仓库，用于代码贡献 |
| **实验成果仓库** | 展示实验结果和文档 | `github.com/Zviolin/Rhino-bird` | 独立仓库，用于展示完整项目过程 |
...
> **本项目的 Fork 仓库**：
> - Fork 仓库：`https://github.com/Zviolin/YOLO-Master`
> - 功能分支：`https://github.com/Zviolin/YOLO-Master/tree/issue-54-mot-experiments`
...
git remote -v
# 应显示:
# origin    https://github.com/Zviolin/YOLO-Master.git (fetch)
# origin    https://github.com/Zviolin/YOLO-Master.git (push)
...
# → https://github.com/Zviolin/YOLO-Master/tree/issue-54-mot-experiments
...
# 4. 在 GitHub 上创建 PR
# 访问: https://github.com/Zviolin/YOLO-Master/pulls
# 点击 "New pull request"
...
├── Codes/                         # 代码目录
│   └── YOLO-Master/               # Zviolin Fork: https://github.com/Zviolin/YOLO-Master
├── Experiments/                   # 实验结果
│   ├── logs/                      # 训练日志
│   ├── weights/                   # 模型权重
│   └── results/                   # 实验结果图表
...
# 或更新现有 PR
# PR 链接：https://github.com/Zviolin/YOLO-Master/pull/new/issue-54-mot-experiments
```
...
- Fork 仓库：`https://github.com/Zviolin/YOLO-Master`
- 功能分支：`https://github.com/Zviolin/YOLO-Master/tree/issue-54-mot-experiments`
- 实验仓库：`https://github.com/Zviolin/Rhino-bird`
